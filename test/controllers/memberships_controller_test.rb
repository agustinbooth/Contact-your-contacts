...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { contact_id: @membership.contact_id, group_id: @membership.group_id } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { contact_id: @membership.contact_id, group_id: @membership.group_id } }
